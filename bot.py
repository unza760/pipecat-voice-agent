...
async def run_bot(transport: BaseTransport, handle_sigint: bool):
    ...
    messages = [
    {
        "role": "system",
        "content": (
            "You are a friendly assistant on an outbound phone call. "
            "Wait for the person to answer and speak first (they will likely say 'Hello'). "
            "Then respond politely and explain why you're calling. "
            "Keep responses concise and conversational. Avoid special characters."
        ),
    },
]
